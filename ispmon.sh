...
iface_1=eth0
iface_2=ppp0
gw_1=$(grep </var/lib/dhcp/dhclient."$iface_1".leases routers | tail -n 1 | grep -oP '(\d+\.){3}\d+')
...
while true; do
    ...
    # Re-define gateways in case they change
